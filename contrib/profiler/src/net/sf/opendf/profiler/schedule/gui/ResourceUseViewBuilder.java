...
public class ResourceUseViewBuilder  
{
	
	public List  create(DataSource data) {
        ...
        return Collections.singletonList(new ChartPanel(chart));
	}


    private IntervalCategoryDataset readResourceUseData(DataSource data)
    {
    	...
    	DefaultHandler saxHandler = new DefaultHandler() {    		
			...
			public void startElement(String uri, String localName, String qName, Attributes attributes) {				
				try {
                    ...
                    Logging.dbg().throwing("ResourceUseViewBuilder", "startElement", e);
			...
			public void endElement(String uri, String localName, String qName) {
				try {
                    ...
                    Logging.dbg().throwing("ResourceUseViewBuilder", "endElement", e);
					throw new RuntimeException(e);
				}
			}			
		...
		try {
			...
			p.parse(data.asInputStream(), saxHandler);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
