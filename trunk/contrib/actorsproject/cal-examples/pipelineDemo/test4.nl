...
entities
	...
	process0_0 = process(affinity=2);
	process0_1 = process(affinity=0);
        consumer0 = art_consumer(affinity=2);

        producer1 = art_producer(affinity=2, N="$N", chunk="$chunk");
	process1_0 = process(affinity=0);
	process1_1 = process(affinity=2);
        consumer1 = art_consumer(affinity=0);

        producer2 = art_producer(affinity=1, N="$N", chunk="$chunk");
	process2_0 = process(affinity=3);
	process2_1 = process(affinity=1);
        consumer2 = art_consumer(affinity=3);

        producer3 = art_producer(affinity=3, N="$N", chunk="$chunk");
	process3_0 = process(affinity=1);
	process3_1 = process(affinity=3);
        consumer3 = art_consumer(affinity=1);
