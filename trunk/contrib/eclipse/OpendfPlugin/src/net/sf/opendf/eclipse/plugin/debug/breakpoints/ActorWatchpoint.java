...
public class PDAWatchpoint extends PDALineBreakpoint implements IWatchpoint {
	...
	public PDAWatchpoint(final IResource resource, final int lineNumber, final String functionName, final String varName, final boolean access, final boolean modification) throws CoreException {
		IWorkspaceRunnable runnable = new IWorkspaceRunnable() {
			public void run(IProgressMonitor monitor) throws CoreException {
				IMarker marker = resource.createMarker("example.debug.core.pda.markerType.watchpoint");
				setMarker(marker);
				setEnabled(true);
	...
	/* (non-Javadoc)
	 * @see example.debug.core.breakpoints.PDALineBreakpoint#createRequest(example.debug.core.model.PDADebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see example.debug.core.breakpoints.PDALineBreakpoint#clearRequest(example.debug.core.model.PDADebugTarget)
	 */
