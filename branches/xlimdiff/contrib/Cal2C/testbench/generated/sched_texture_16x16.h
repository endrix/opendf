#ifndef SCHED_TEXTURE_16X16_H
#define SCHED_TEXTURE_16X16_H

#include "broadcaster.h"
#include "sched_DC_Reconstruction_16x16.h"
...
SC_MODULE(sched_texture_16x16) {
  ...
  sched_DC_Reconstruction_16x16 DCRecontruction;
  sched_MPEG4_algo_IS IS;
  sched_MPEG4_algo_IAP_16x16 IAP;
  ...
  SC_HAS_PROCESS(sched_texture_16x16);

  sched_texture_16x16(sc_module_name N) : sc_module(N),
