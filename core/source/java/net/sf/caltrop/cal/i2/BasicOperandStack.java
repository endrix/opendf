...
public class BasicOperandStack implements OperandStack {
	...
	public void  replaceWithResult(int n, Object v) {
		if (n == 0) {
			...
			// zero slots above tos, to allow objects to become garbage collected
			// FIXME: do not do this every time, but only at certain intervals, or when
			//        the operand stack empties, ...
